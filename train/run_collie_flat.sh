...
echo "=== TRAIN reason ==="
COLLIE_TRAIN=/workspace/data/collie_flat_reason_train.jsonl \
COLLIE_RUN_DIR=/workspace/collie-flat-reason \
python /workspace/train_collie.py 2>&1

echo "=== TRAIN direct ==="
COLLIE_TRAIN=/workspace/data/collie_flat_direct_train.jsonl \
COLLIE_RUN_DIR=/workspace/collie-flat-direct \
python /workspace/train_collie.py 2>&1

echo "=== GEN reason preds ==="
COLLIE_MODEL_DIR=/workspace/collie-flat-reason/final \
COLLIE_EVAL=/workspace/data/collie_flat_reason_eval.jsonl \
COLLIE_PRED_OUT=/workspace/preds_flat_reason.jsonl \
COLLIE_MAXNEW=380 \
python /workspace/gen_collie_preds.py 2>&1

echo "=== GEN direct preds ==="
COLLIE_MODEL_DIR=/workspace/collie-flat-direct/final \
COLLIE_EVAL=/workspace/data/collie_flat_direct_eval.jsonl \
COLLIE_PRED_OUT=/workspace/preds_flat_direct.jsonl \
COLLIE_MAXNEW=120 \
python /workspace/gen_collie_preds.py 2>&1
